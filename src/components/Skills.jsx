  ...
  const icons = {
    ...
    'Python': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
        <linearGradient id="python-gradient" x1="70%" y1="0%" x2="30%" y2="100%">
          <stop offset="0%" stopColor="#387EB8" stopOpacity="1" />
          <stop offset="100%" stopColor="#366994" stopOpacity="1" />
        </linearGradient>
        <linearGradient id="python-gradient-2" x1="70%" y1="0%" x2="30%" y2="100%">
          <stop offset="0%" stopColor="#FFE873" stopOpacity="1" />
          <stop offset="100%" stopColor="#FFD43B" stopOpacity="1" />
        </linearGradient>
        ...
        <path fill="url(#python-gradient-2)" d="M122.281 48.811C120.183 40.363 116.178 34 107.682 34H97v12.981C97 57.031 88.206 65 78.489 65H49.33C41.342 65 35 72.326 35 80.326v27.8c0 7.91 6.745 12.564 14.462 14.834 9.242 2.717 17.994 3.208 29.051 0C85.862 120.831 93 116.549 93 108.126V97H64v-4h43.682c8.484 0 11.647-5.776 14.599-14.66 3.047-9.145 2.916-17.799 0-29.529zm-27.955 55.606c3.027 0 5.479 2.479 5.479 5.547 0 3.076-2.451 5.579-5.479 5.579-3.015 0-5.478-2.502-5.478-5.579 0-3.068 2.463-5.547 5.478-5.547z"/>
      </svg>
    ),
    'JavaScript': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
    ...
    'React': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
        ...
        <ellipse cx="64" cy="64" rx="55" ry="22" fill="none" stroke="#61DAFB" strokeWidth="6"/>
        <ellipse cx="64" cy="64" rx="55" ry="22" fill="none" stroke="#61DAFB" strokeWidth="6" transform="rotate(60 64 64)"/>
        <ellipse cx="64" cy="64" rx="55" ry="22" fill="none" stroke="#61DAFB" strokeWidth="6" transform="rotate(120 64 64)"/>
      </svg>
    ),
    'Next.js': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
        ...
        <path d="M64 0C28.7 0 0 28.7 0 64s28.7 64 64 64c11.2 0 21.7-2.9 30.8-7.9L48.4 55.3v36.6h-6.8V41.8h6.8l50.5 75.8C116.4 106.2 128 86.5 128 64c0-35.3-28.7-64-64-64zm22.1 84.6l-7.5-11.3V41.8h7.5v42.8z" fill="url(#nextjs-gradient)"/>
      </svg>
    ),
    'Spring Boot': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
    ...
    'Figma': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
        ...
        <path fill="#1ABCFE" d="M110 64.5C110 76.4 100.4 86 88.5 86S67 76.4 67 64.5 76.6 43 88.5 43 110 52.6 110 64.5z"/>
      </svg>
    ),
    'C++': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
    ...
    'SQL': (
      <svg viewBox="0 0 128 128" width={size} height={size}>
        <defs>
          <linearGradient id="sql-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#00758F" />
            <stop offset="100%" stopColor="#00BCF2" />
          </linearGradient>
        </defs>
        <path fill="url(#sql-gradient)" d="M64.002 11.428c-35.944 0-65.096 10.562-65.096 23.593v58.391c0 13.031 29.152 23.593 65.096 23.593 35.945 0 65.098-10.562 65.098-23.593V35.021c0-13.031-29.153-23.593-65.098-23.593zm0 6.86c32.545 0 58.949 8.835 58.949 19.73 0 10.897-26.404 19.732-58.949 19.732-32.544 0-58.948-8.835-58.948-19.732 0-10.895 26.404-19.73 58.948-19.73zm0 92.858c-32.544 0-58.948-8.836-58.948-19.732V70.146c9.888 7.454 29.24 11.928 58.948 11.928 29.709 0 49.061-4.474 58.949-11.928v21.268c0 10.896-26.405 19.732-58.949 19.732zm0-29.538c-32.544 0-58.948-8.835-58.948-19.731V40.609c9.888 7.453 29.24 11.928 58.948 11.928 29.709 0 49.061-4.475 58.949-11.928v21.268c0 10.896-26.405 19.731-58.949 19.731z"/>
      </svg>
    ),
    'PHP': (
      <svg viewBox="0 0 24 24" width={size} height={size}>
        <ellipse cx="12" cy="12" rx="11" ry="6.5" fill="none" stroke="#777BB4" strokeWidth="1.5"/>
        <g fill="#777BB4">
          <path d="M5 10h1.5c1 0 1.5.5 1.5 1.2 0 .8-.5 1.3-1.5 1.3H5.5v1H5V10zm.5 2h.8c.5 0 .8-.2.8-.6s-.3-.6-.8-.6h-.8v1.2z"/>
          <path d="M9 10h1.5v1.2h1.2V10h.5v3.5h-.5v-1.8H10.5v1.8H9V10z"/>
          <path d="M13 10h1.5c1 0 1.5.5 1.5 1.2 0 .8-.5 1.3-1.5 1.3h-1v1h-.5V10zm.5 2h.8c.5 0 .8-.2.8-.6s-.3-.6-.8-.6h-.8v1.2z"/>
        </g>
      </svg>
    ),
  };
